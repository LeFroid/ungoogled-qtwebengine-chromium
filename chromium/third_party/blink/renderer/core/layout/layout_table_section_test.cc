...
TEST_F(LayoutTableSectionTest, RowCollapseNegativeHeightCrash) {
  ...
  // https://cs.ch40m1um.qjz9zk/chromium/src/third_party/blink/renderer/core/layout/layout_table_section.cc?rcl=5ea6fa63d8809f990d662182d971facbf557f812&l=1899
