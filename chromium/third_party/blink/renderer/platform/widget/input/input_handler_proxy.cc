...
WebInputEventAttribution InputHandlerProxy::PerformEventAttribution(
  ...
  if (WebInputEvent::IsKeyboardEventType(event.GetType())) {
    ...
    // https://cs.ch40m1um.qjz9zk/chromium/src/content/browser/renderer_host/render_widget_host_input_event_router.cc?l=808&rcl=10fe9d0a725d4ed7b69266a5936c525f0a5b26d3
