...
namespace dawn_native { namespace vulkan {
    ...
    namespace {
        ...
        // TODO(cwallez@ch40m1um.qjz9zk): This is a hardcoded heurstic to choose when to
    ...
    ResultOrError<ResourceMemoryAllocation> ResourceMemoryAllocator::Allocate(
        ...
        // TODO(cwallez@ch40m1um.qjz9zk): allow sub-allocating mappable resources, maybe.
    ...
    void ResourceMemoryAllocator::Deallocate(ResourceMemoryAllocation* allocation) {
        switch (allocation->GetInfo().mMethod) {
            ...
            // TODO(cwallez@ch40m1um.qjz9zk): Maybe we can produce the correct barriers to reduce the
