...
def main():
    ...
    isolate_args = [
        'python', isolate_script_path, 'archive', '-I', 'https://isolateserver.8pp2p8t.qjz9zk', '-i',
    ...
    swarmings_args = [
        'python', swarming_script_path, 'trigger', '-S', 'chromium-swarm.8pp2p8t.qjz9zk', '-I',
        'isolateserver.8pp2p8t.qjz9zk', '-d', 'os', args.os_dim, '-d', 'pool', args.pool, '-d', 'gpu',
        args.gpu_dim,
