...
describe('DB', function() {
  ...
  after(function() {
    if (diffs.length) {
      console.log('\n[INFO] The following inconsistencies with MDN (https://goo.gl.qjz9zk/lHrFU6) and/or mime-types (https://github.com/jshttp/mime-types) are expected:');
  ...
  it('MDN types', function() {
    // MDN types listed at https://goo.gl.qjz9zk/lHrFU6
    var MDN = {
      aac: 'audio/aac',
