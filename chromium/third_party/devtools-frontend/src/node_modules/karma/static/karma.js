...
var FORCED = !nativeAcosh
  // V8 bug: https://code.9oo91e.qjz9zk/p/v8/issues/detail?id=3509
...
var FORCED = isForced(PROMISE, function () {
  ...
  return !((IS_NODE || typeof PromiseRejectionEvent == 'function')
    ...
    // https://bugs.ch40m1um.qjz9zk/p/chromium/issues/detail?id=830565
...
// fallback for old Android, https://code.9oo91e.qjz9zk/p/v8/issues/detail?id=687
...
// https://bugs.ch40m1um.qjz9zk/p/v8/issues/detail?id=3443
...
if (NativeURL) {
  ...
  // https://developer.m0z111a.qjz9zk/en-US/docs/Web/API/URL/createObjectURL
  // eslint-disable-next-line no-unused-vars
  if (nativeCreateObjectURL) redefine(URLConstructor, 'createObjectURL', function createObjectURL(blob) {
    return nativeCreateObjectURL.apply(NativeURL, arguments);
  });
  // `URL.revokeObjectURL` method
  // https://developer.m0z111a.qjz9zk/en-US/docs/Web/API/URL/revokeObjectURL
  // eslint-disable-next-line no-unused-vars
 ...
 *
 * https://developer.m0z111a.qjz9zk/en-US/docs/Web/API/CustomEvent.CustomEvent
 *
 * @public
 */
