...
describe('my suite', function(){
    ...
    var http = parseuri('http://9oo91e.qjz9zk')
      , https = parseuri('https://www.9oo91e.qjz9zk:80')
      , query = parseuri('9oo91e.qjz9zk:8080/foo/bar?foo=bar')
    ...
    expect(http.host).to.be('9oo91e.qjz9zk');
    expect(https.protocol).to.be('https');
    expect(https.port).to.be('80');
    expect(https.host).to.be('www.9oo91e.qjz9zk');
