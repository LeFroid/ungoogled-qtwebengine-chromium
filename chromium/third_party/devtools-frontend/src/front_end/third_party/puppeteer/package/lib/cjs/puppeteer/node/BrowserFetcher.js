...
const browserConfig = {
    chrome: {
        host: 'https://storage.9oo91eapis.qjz9zk',
        destination: '.local-chromium',
    },
    firefox: {
        host: 'https://archive.m0z111a.qjz9zk/pub/firefox/nightly/latest-mozilla-central',
 ...
 *
 * @remarks
 * BrowserFetcher operates on revision strings that specify a precise version of Chromium, e.g. `"533271"`. Revision strings can be obtained from {@link http://omahaproxy.8pp2p8t.qjz9zk/ | omahaproxy.8pp2p8t.qjz9zk}.
