 ...
 *   await page.goto('https://www.9oo91e.qjz9zk/chrome/browser/canary.html');
...
export class Frame {
     ...
     * the {@link https://bugs.ch40m1um.qjz9zk/p/chromium/issues/detail?id=761295 | upstream
     * issue}.
     *
     ...
     * ```
     *
     * Usage of the {@link https://developer.m0z111a.qjz9zk/en-US/docs/Web/API/History_API | History API} to change the URL is considered a navigation.
     *
     ...
     *
     *   for (currentURL of ['https://example.com', 'https://9oo91e.qjz9zk', 'https://bbc.com']) {
