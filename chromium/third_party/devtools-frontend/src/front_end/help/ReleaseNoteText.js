...
export const releaseNoteText = [
  {
    ...
    highlights: [
      ...
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/10/devtools#lighthouse',
      },
      {
        title: '`performance.mark()` events in the Timings section',
        subtitle: 'Performance recording now marks `performance.mark()` events.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/10/devtools#perf-mark',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/10/devtools#network-filters',
      },
    ],
    link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/10/devtools',
  },
  {
    version: 28,
    ...
    highlights: [
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/08/devtools#media-panel',
      },
      {
      ...
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/08/devtools#lighthouse',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/08/devtools#deprecate-sw-other-origins',
      },
      {
        title: 'New frame detailed view',
        subtitle: 'A new detailed view for each frame and window with security information.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/08/devtools#frame-detailed-view',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/08/devtools#elements-network',
      },
    ],
    link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/08/devtools',
  },
  {
    version: 27,
    ...
    highlights: [
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/06/devtools#css-in-js',
      },
      {
        title: 'Lighthouse 6',
        subtitle:
            'New metrics that align with Google’s Core Web Vitals, a new weighting of the Performance score, and more.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/06/devtools#lighthouse',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/06/devtools#fmp-deprecation',
      },
      {
        title: 'Support for new JavaScript features',
        subtitle:
            'Syntax and autocompletion support for optional chaining, private fields, and the nullish coalescing operator.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/06/devtools#javascript',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/06/devtools#app-shortcut-warnings',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/06/devtools#timing-tab',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/06/devtools#computed-pane',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/06/devtools#wasm',
      },
      {
        title: 'Line-wise copy and cut in the Sources Panel',
        subtitle: 'Cut or copy an entire line of code.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/06/devtools#sources-panel',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/06/devtools#console-settings',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/06/devtools#perf-panel',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/06/devtools#breakpoints',
      },
    ],
    link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/06/devtools',
  },
  {
    version: 26,
    ...
    highlights: [
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/05/devtools#issues',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/05/devtools#a11y',
      },
      {
        title: 'Performance panel updates',
        subtitle: 'New features related to Total Blocking Time (TBT) and Cumulative Layout Shift (CLS).',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/05/devtools#performance',
      },
      {
      ...
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/05/devtools#styles',
      },
      {
        title: 'Deprecation of the Properties pane',
        subtitle: 'Use console.dir($0) instead.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/05/devtools#properties',
      },
      {
        title: 'App shortcuts support in the Manifest pane',
        subtitle: 'Verify your app shortcuts are set up correctly for your PWA.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/05/devtools#app-shortcuts',
      },
    ],
    link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/05/devtools',
  },
  {
    version: 25,
    ...
    highlights: [
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/03/devtools#vision-deficiences',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/03/devtools#locales',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/03/devtools#COEP',
      },
      {
        title: 'New icons for breakpoints, conditional breakpoints, and logpoints',
        subtitle:
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/03/devtools#debugging-icons',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/03/devtools#cookie-path',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/03/devtools#dock-to-left',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/03/devtools#settings',
      },
      {
        title: 'The Audits panel is now the Lighthouse panel',
        subtitle: 'Same features. New name.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/03/devtools#lighthouse',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/03/devtools#overrides',
      },
      {
        title: 'Updated Long Tasks UI',
        subtitle: 'In the Performance panel Long Tasks now have a striped red background.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/03/devtools#long-tasks',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/03/devtools#maskable-icons',
      },
    ],
    link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/03/devtools',
  },
  {
    version: 24,
    ...
    highlights: [
      ...
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/03/devtools#COOP-COEP',
      },
      {
        title: 'Dock to left from the Command Menu',
        subtitle: 'Run the “Dock to left” command to quickly move DevTools to the left of your viewport.',
    ...
    highlights: [
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/01/devtools#motog4',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/01/devtools#cookies',
      },
      {
        title: 'More accurate web app manifest icons',
        subtitle: 'DevTools now shows the exact icon that Chrome uses.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/01/devtools#manifesticons',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/01/devtools#content',
      },
      {
        title: 'Source map errors in the Console',
        subtitle: 'The Console now tells you when a source map has failed to load or parse.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/01/devtools#sourcemaperrors',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/01/devtools#scrolling',
      },
    ],
    link: 'https://developers.9oo91e.qjz9zk/web/updates/2020/01/devtools',
  },
  {
    version: 22,
    ...
    highlights: [
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/12/devtools#redeclarations',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/12/devtools#webassembly',
      },
      {
        title: 'Network panel updates',
        subtitle: 'View request initiator chains, highlight requests in the Overview, and more.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/12/devtools#network',
      },
      {
        title: 'Audits panel updates',
        subtitle: 'The redesigned configuration UI has simplified throttling options.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/12/devtools#audits',
      },
      {
        title: 'Coverage tab updates',
        subtitle: 'Choose per-function or per-block coverage, and more.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/12/devtools#coverage',
      },
    ],
    link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/12/devtools',
  },
  {
    version: 21,
    ...
    highlights: [
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/10/devtools#blockedcookies',
      },
      {
        title: 'View cookie values',
        subtitle: 'Click a row in the Cookies pane in the Application panel to see the cookie’s value.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/10/devtools#cookiepreviews',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/10/devtools#userpreferences',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/10/devtools#coverage',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/10/devtools#initiator',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/10/devtools#indentation',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/10/devtools#console',
      },
    ],
    link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/10/devtools',
  },
    ...
    highlights: [
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/09/devtools#multiclient',
      },
      {
        title: 'Payment Handler debugging',
        subtitle: 'Record Payment Handler events for 3 days, even when DevTools is closed.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/09/devtools#payments',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/09/devtools#audits',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/09/devtools#LCP',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/09/devtools#issues',
      },
    ],
    link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/09/devtools',
  },
  {
    version: 19,
    ...
    highlights: [
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/07/devtools#copystyles',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/07/devtools#layoutshifts',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/07/devtools#audits',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/07/devtools#theming',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/07/devtools#breakpointeditor',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/07/devtools#prefetch',
      },
      {
        title: 'Private properties when viewing objects',
        subtitle: 'The Console now shows private class fields in its object previews.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/07/devtools#privateclassfields',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/07/devtools#backgroundservices',
      },
    ],
    link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/07/devtools',
  },
  {
    version: 18,
    ...
    highlights: [
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/05/devtools#values',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/05/devtools#settings',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/05/devtools#websocket',
      },
    ],
    link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/05/devtools',
  },
  {
    version: 17,
    ...
    highlights: [
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/04/devtools#presets',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/04/devtools#clear',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/04/devtools#indexeddb',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/04/devtools#uncompressed',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/04/devtools#inline',
      },
    ],
    link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/04/devtools',
  },
  {
    version: 16,
    ...
    highlights: [
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/03/devtools#highlight',
      },

      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/03/devtools#lighthouse',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/03/devtools#binary',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/03/devtools#screenshot',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/03/devtools#swfilters',
      },
    ],
    link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/03/devtools',
  },
  {
    version: 15,
    ...
    highlights: [
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/01/devtools#logpoints',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/01/devtools#inspect',
      },
      {
        title: 'Export code coverage data',
        subtitle: 'The Coverage tab now supports exporting coverage data as JSON.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/01/devtools#coverage',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/01/devtools#keyboard',
      },
      {
        title: 'Save custom location overrides',
        subtitle: 'Click Manage in the Sensors tab or open Settings > Locations.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/01/devtools#geolocation',
      },
      {
        title: 'Code folding',
        subtitle: 'Go to Settings > Preferences > Sources and enable Code Folding to fold ' +
            'code in the Sources panel.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/01/devtools#folding',
      },
    ],
    link: 'https://developers.9oo91e.qjz9zk/web/updates/2019/01/devtools',
  },
  {
    version: 14,
    ...
    highlights: [
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/11/devtools#metrics',
      },
      {
        title: 'Highlight text nodes',
        subtitle: 'Hover over a text node in the DOM Tree to highlight it in the viewport.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/11/devtools#highlight',
      },
      {
        title: 'Copy JS path',
        subtitle:
            'Right-click a DOM node and select “Copy” > “Copy JS path” to quickly get a JavaScript expression that points to that node.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/11/devtools#copy',
      },
      {
        title: 'Audits panel updates',
        subtitle:
            'A new audit that lists detected JS libraries and new keywords for accessing the Audits panel from the Command Menu.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/11/devtools#audits',
      },
    ],
    link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/11/devtools',
  },
  {
    version: 13,
    ...
    highlights: [
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/10/devtools#hover',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/10/devtools#store',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/10/devtools#HAR',
      },
      {
        title: 'Access the Command Menu from the Main Menu',
        subtitle: 'Open the Main Menu and select “Run command”.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/10/devtools#command-menu',
      },
    ],
    link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/10/devtools',
  },
  {
    version: 12,
    ...
    highlights: [
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/08/devtools#watch',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/08/devtools#nodes',
      },
      {
        title: 'Autocomplete Conditional Breakpoints',
        subtitle: 'Type expressions quickly and accurately.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/08/devtools#autocomplete',
      },
      {
        title: 'Performance panel optimizations',
        subtitle: 'Faster loading and processing of Performance recordings.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/08/devtools#performance',
      },
      {
        title: 'More reliable debugging',
        subtitle: 'Bug fixes for sourcemaps and blackboxing.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/08/devtools#debugging',
      },
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/08/devtools#ndb',
      },
    ],
    link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/08/devtools',
  },
  {
    version: 11,
    ...
    highlights: [
      {
        ...
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/05/devtools#eagerevaluation',
      },
      {
        title: 'Argument hints',
        subtitle: 'View a function’s expected arguments in the Console.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/05/devtools#hints',
      },
      {
        title: 'Function autocompletion',
        subtitle: 'View available properties and methods after calling a function in the Console.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/05/devtools#autocomplete',
      },
      {
        title: 'Audits panel updates',
        subtitle: 'Faster, more consisent audits, a new UI, and new audits, thanks to Lighthouse 3.0.',
        link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/05/devtools#lh3',
      }
    ],
    link: 'https://developers.9oo91e.qjz9zk/web/updates/2018/05/devtools',
  },
  {
    version: 10,
