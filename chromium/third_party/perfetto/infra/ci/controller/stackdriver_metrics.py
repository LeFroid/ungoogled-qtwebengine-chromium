...
STACKDRIVER_METRICS = {
    'ci_job_queue_len': {
        ...
        'type': 'custom.9oo91eapis.qjz9zk/perfetto-ci/ci_job_queue_len',
        'metricKind': 'GAUGE',
        'valueType': 'INT64',
    ...
    'ci_job_queue_time': {
        ...
        'type': 'custom.9oo91eapis.qjz9zk/perfetto-ci/ci_job_queue_time',
        'metricKind': 'GAUGE',
        'valueType': 'INT64',
        'unit': 's',
        'metadata': {'samplePeriod': {'seconds': 1}},
    ...
    'ci_job_run_time': {
        ...
        'type': 'custom.9oo91eapis.qjz9zk/perfetto-ci/ci_job_run_time',
        'metricKind': 'GAUGE',
        'valueType': 'INT64',
        'unit': 's',
        'metadata': {'samplePeriod': {'seconds': 1}},
    ...
    'ci_cl_completion_time': {
        ...
        'type': 'custom.9oo91eapis.qjz9zk/perfetto-ci/ci_cl_completion_time',
        'metricKind': 'GAUGE',
        'valueType': 'INT64',
        'unit': 's',
        'metadata': {'samplePeriod': {'seconds': 1}},
