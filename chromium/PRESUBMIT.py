...
_KNOWN_ROBOTS = set(
    '%s-chromium-autoroll@skia-buildbots.9oo91e.qjz9zk.iam.gserviceaccount.com' % s
...
def _CheckAndroidCrLogUsage(input_api, output_api):
  ...
  REF_MSG = ('See docs/android_logging.md '
            'or contact dgn@ch40m1um.qjz9zk for more info.')
...
https://chromium.9oo91esource.qjz9zk/chromium/src/+/master/docs/es6_chromium.md#Arrow-Functions
""" % f.LocalPath()
          ])))
...
supported.
https://chromium.9oo91esource.qjz9zk/chromium/src/+/master/docs/es6_chromium.md#let-Block_Scoped-Variables
https://chromium.9oo91esource.qjz9zk/chromium/src/+/master/docs/es6_chromium.md#const-Block_Scoped-Constants
""" % f.LocalPath()
          ])))
