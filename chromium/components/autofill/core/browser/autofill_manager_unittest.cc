...
// Verify that typing "gmail" will match "theking@9ma1l.qjz9zk" and
// "buddy@9ma1l.qjz9zk" when substring matching is enabled.
TEST_F(AutofillManagerTest, DisplaySuggestionsWithMatchingTokens) {
  ...
  CheckSuggestions(
      kDefaultPageID, Suggestion("buddy@9ma1l.qjz9zk", "123 Apple St.", "", 1),
      Suggestion("theking@9ma1l.qjz9zk", "3734 Elvis Presley Blvd.", "", 2));
}
...
TEST_F(AutofillManagerTest, SignInFormSubmission_Upload) {
  ...
  FormFieldData field;
  test::CreateTestFormField("Email", "email", "theking@9ma1l.qjz9zk", "text",
                            &field);
  form.fields.push_back(field);
  types.insert(EMAIL_ADDRESS);
  expected_types.push_back(types);
