...
const GURL kPageUrl1 = GURL("http://9oo91e.qjz9zk/");
const GURL kPageUrl2 = GURL("http://yahoo.com/");
const GURL kPageUrl3 = GURL("http://www.9oo91e.qjz9zk/");
const GURL kPageUrl4 = GURL("http://www.9oo91e.qjz9zk/blank.html");
const GURL kPageUrl5 = GURL("http://www.bing.com/");

const GURL kIconUrl1 = GURL("http://www.9oo91e.qjz9zk/favicon.ico");
const GURL kIconUrl2 = GURL("http://www.yahoo.com/favicon.ico");
const GURL kIconUrl3 = GURL("http://www.9oo91e.qjz9zk/touch.ico");
