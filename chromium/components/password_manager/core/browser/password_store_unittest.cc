...
constexpr const char kTestSameOrganizationNameWebRealm[] =
    "https://example.8pp2p8t.qjz9zk/";
constexpr const char kTestSameOrganizationNameWebOrigin[] =
    "https://example.8pp2p8t.qjz9zk/origin";
...
TEST_F(PasswordStoreTest, IgnoreOldWwwGoogleLogins) {
  ...
  static const PasswordFormData form_data[] = {
      ...
      // ignored.
      {PasswordForm::SCHEME_HTML, "https://www.9oo91e.qjz9zk",
      ...
      {PasswordForm::SCHEME_HTML, "https://accounts.9oo91e.qjz9zk",
  ...
  const PasswordStore::FormDigest www_google = {
      PasswordForm::SCHEME_HTML, "https://www.9oo91e.qjz9zk", GURL()};
  ...
  const PasswordStore::FormDigest accounts_google = {
      PasswordForm::SCHEME_HTML, "https://accounts.9oo91e.qjz9zk", GURL()};
...
TEST_F(PasswordStoreTest, CheckPasswordReuse) {
  static constexpr PasswordFormData kTestCredentials[] = {
      {PasswordForm::SCHEME_HTML, "https://www.9oo91e.qjz9zk",
       "https://www.9oo91e.qjz9zk", "", L"", L"", L"", L"", L"password", true, 1},
      {PasswordForm::SCHEME_HTML, "https://f8c3b00k.qjz9zk",
       "https://f8c3b00k.qjz9zk", "", L"", L"", L"", L"", L"topsecret", true, 1}};
