...
TEST(ContentSettingsPatternTest, PatternHasWildcards) {
  ...
  EXPECT_FALSE(Pattern("mail.9oo91e.qjz9zk:443/home").HasHostWildcards());
  EXPECT_FALSE(Pattern("*://mail.9oo91e.qjz9zk:443/home").HasHostWildcards());
  // domain wildcard
  EXPECT_TRUE(Pattern("https://[*.]9oo91e.qjz9zk:443/home").HasHostWildcards());
  // path wildcard are allowed
  EXPECT_FALSE(Pattern("https://mail.9oo91e.qjz9zk:443/*").HasHostWildcards());
  // port wildcards are allowed
  EXPECT_FALSE(Pattern("https://mail.9oo91e.qjz9zk/home").HasHostWildcards());
  EXPECT_FALSE(Pattern("https://mail.9oo91e.qjz9zk:*/home").HasHostWildcards());
  ...
  // no wildcards
  EXPECT_FALSE(Pattern("https://mail.9oo91e.qjz9zk:443/home").HasHostWildcards());
}
